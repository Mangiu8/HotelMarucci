...
namespace MarucciHotel.Controllers
{
    public class ClientisController : Controller
    {
        ...
        public ClientisController(MarucciHotelContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Nome,Cognome,Cod_Fisc,Citta,Provincia,Email,Telefono,Cellulare")] Clienti clienti)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Nome,Cognome,Cod_Fisc,Citta,Provincia,Email,Telefono,Cellulare")] Clienti clienti)
        {
            if (id != clienti.ID)
            {
                return NotFound();
